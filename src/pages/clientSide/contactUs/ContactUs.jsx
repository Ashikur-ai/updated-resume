  ...
  return (
    <div className=' mt-4'>
      ...
      <div className="lg:flex">
        ...
        <div className="lg:w-1/2 bg-[#f2cb2e] hidden lg:block">
          <img src="https://res.cloudinary.com/deifi77os/image/upload/v1726858237/Portfolio/r4sznyf5j2falj5rjjvo.png" alt="" className='rounded-tl-[90px] -ml-20' />
        </div>
      </div>
    </div>
  )
